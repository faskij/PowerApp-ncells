...
ncells(m1 = frac_m_genes, pi1=val, foldchange = fold_ch, dropout = drop_rate, p = unique_gene_count, n = n_cells, mu = mean_expression, sigma = standard_deviation, dfactor= c(T,T), B = 100)
...
row <- ncells(m1 = frac_m_genes, pi1=val, foldchange = fold_ch, dropout = drop_rate, p = unique_gene_count, n = n_cells, mu = mean_expression, sigma = standard_deviation, dfactor= F, B = 100)
